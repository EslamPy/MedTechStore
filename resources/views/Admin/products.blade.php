            ...
            <div class="row tm-content-row">
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-products">
                            ...
                            <table class="table table-hover tm-table-small tm-product-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="tm-product-name"><a href="{{ route('edit') }}"
                                    ...
                                    <tr>
                                        <th scope="row"><input type="checkbox" /></th>
                                        <td class="tm-product-name"><a href="{{ route('edit') }}" style="text-decoration: none; color: inherit;">Lorem Ipsum Product 1</a>
                                        </td>
                                        <td>1,000</td>
                                        <td>600</td>
                                        <td>08 Feb 2019</td>
                        ...
                        <!-- table container -->
                        <a href="{{ route('add') }}" class="btn btn-primary btn-block text-uppercase mb-3">Add new product</a>
